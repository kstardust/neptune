...
var file_math_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x6e, 0x65,
	0x70, 0x74, 0x75, 0x6e, 0x65, 0x22, 0x1b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x38, 0x0a, 0x04, 0x4d, 0x61, 0x74, 0x68, 0x12, 0x30,
	0x0a, 0x03, 0x4d, 0x61, 0x78, 0x12, 0x10, 0x2e, 0x6e, 0x65, 0x70, 0x74, 0x75, 0x6e, 0x65, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x6e, 0x65, 0x70, 0x74, 0x75, 0x6e,
...
var file_math_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: neptune.Request
	(*Response)(nil), // 1: neptune.Response
}
var file_math_proto_depIdxs = []int32{
	0, // 0: neptune.Math.Max:input_type -> neptune.Request
	1, // 1: neptune.Math.Max:output_type -> neptune.Response
...
func (c *mathClient) Max(ctx context.Context, opts ...grpc.CallOption) (Math_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Math_serviceDesc.Streams[0], "/neptune.Math/Max", opts...)
	if err != nil {
		return nil, err
	}
