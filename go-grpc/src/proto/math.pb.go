...
var file_math_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x67, 0x72,
	0x70, 0x63, 0x5f, 0x6d, 0x61, 0x74, 0x68, 0x22, 0x1b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x3c, 0x0a, 0x04, 0x4d, 0x61, 0x74, 0x68,
	0x12, 0x34, 0x0a, 0x03, 0x4d, 0x61, 0x78, 0x12, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x6d,
	0x61, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x5f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_math_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: grpc_math.Request
	(*Response)(nil), // 1: grpc_math.Response
}
var file_math_proto_depIdxs = []int32{
	0, // 0: grpc_math.Math.Max:input_type -> grpc_math.Request
	1, // 1: grpc_math.Math.Max:output_type -> grpc_math.Response
...
func (c *mathClient) Max(ctx context.Context, opts ...grpc.CallOption) (Math_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Math_serviceDesc.Streams[0], "/grpc_math.Math/Max", opts...)
	if err != nil {
		return nil, err
	}
